...
namespace Gestao_Patrimonios.Contexts;

public partial class Gestao_PatrimoniosContext : DbContext
{
    public Gestao_PatrimoniosContext()
    {
    }

    public Gestao_PatrimoniosContext(DbContextOptions<Gestao_PatrimoniosContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=D06S31-1313863\\SQLEXPRRESS;Database=Gestao_Patrimonios;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Area>(entity =>
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B82028D2D53705");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A7797605941B62B").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623D0D1D42B");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED288D8670");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DEABD1079E").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B68009596EC3DEA7");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F710EB623");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECAFD642BCA");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B6D7B82A6");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE1AB97948");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35D3636AC5B").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F22CE0A167");
            ...
            entity.HasOne(d => d.UsuarioSolicitado).WithMany(p => p.SolicitacaoTransferenciaUsuarioSolicitado)
                .HasForeignKey(d => d.UsuarioSolicitadoID)
                .HasConstraintName("FK_SolicitacaoTransferencia_UsuarioSolicitado");

            entity.HasOne(d => d.UsuarioSolicitante).WithMany(p => p.SolicitacaoTransferenciaUsuarioSolicitante)
                .HasForeignKey(d => d.UsuarioSolicitanteID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SolicitacaoTransferencia_UsuarioSolicitante");
        });

        modelBuilder.Entity<StatusPatrimonio>(entity =>
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F33609924CC0B8");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A9AC63F9F").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B9AD2E8279");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1AD4846D78").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0DF8F01888");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10ADA85F3D5").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoPatrimonioID).HasName("PK__TipoPatr__4DC9FF99DE06157E");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoPatr__7859A10A68A4656A").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C702704A9B76");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10A0C7D503C").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE7981B043DA5");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C853D36BDC").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA20D5F9A2A").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534586494ED").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731C387D13A").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC330782E724D").IsUnique();
